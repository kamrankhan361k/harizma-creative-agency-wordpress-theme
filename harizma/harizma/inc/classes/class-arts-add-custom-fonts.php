...
class Arts_Add_Custom_Fonts {
	...
	public function prepare_custom_fonts_acf() {
		...
		// Stop ACF from trying to look for a language-specific version of fields.
		...
		// Re-enable language-specific retrieval of ACF fields.
	...
	public function add_custom_fonts( $custom_choice ) {
		...
		$custom_choice['families']['custom'] = array(
			'text'     => esc_attr__( 'Custom Fonts', 'harizma' ),
	...
	public function print_custom_css() {
		...
		if ( ! empty (self::$css_to_print) ) {
			add_action('wp_enqueue_scripts', function() {
				wp_add_inline_style( 'harizma-main-style', trim( self::$css_to_print ) );
			}, 30);
		}
